...
from .uuuuuu import hsv2rgb, gamma_line, color_img, make_color_lut, get_sides_points
...
class ImageView(QObject):
    ...
    * curve change for not rgb ----> on the channel which is visible
    ...
    def set_data(self, image_file):
        ...
        self.img_stacks.set_lut(self.color_lut_list)
    ...
    def get_corner_and_lines(self):
        self.side_lines, self.corner_points = get_sides_points(self.img_size)
