...
class LayersControl(QWidget):
    ...
    def add_layer(self, link='None'):
        new_layer = SingleLayer(index=self.layer_count, link=link)
        new_layer.text_btn.setText(link)
    ...
    def delete_layer(self):
        ...
        for ind in current_ids_copy:
            ...
            remove_from_current_ind = [i for i in range(len(self.current_layer_ind)) if self.current_layer_ind[i] == ind][0]
